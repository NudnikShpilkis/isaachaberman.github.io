...
```{r Modeling of GDP, warning = FALSE, message = FALSE, cache = TRUE, results = "hide"}
...
```{r Comparing GDP models, warning = FALSE, message = FALSE, results = "hide"}
...
```{r Predicting GDP model, warning = FALSE, message = FALSE, cache = TRUE,  results = "hide"}
...
kable(gdp.pred.mse, format = "html")
...
```{r Model of GDP t - 1 noPro, warning= FALSE, message = FALSE, cache = TRUE,  results = "hide"}
...
kable(t1.noPro.b.mse, format = "html")
...
```{r t1 Predictions, warning = FALSE, message = FALSE, cache = TRUE,  results = "hide"}
...
kable(t1.noPro.pred.mse, format = "html")
...
```{r t - 1 model comparison, message = FALSE, warning = FALSE, cache = TRUE,  results = "hide"}
...
```{r t - 1 model summary, message = FALSE, warning = FALSE,  results = "hide"}
...
```{r t - 1 predictions, message = FALSE, warning = FALSE, cache = TRUE,  results = "hide"}
...
```{r Additive Regressions, message = FALSE, warning = FALSE}
...
```{r Productivity Model, message = FALSE, warning = FALSE, cache = TRUE,  results = "hide"}
...
```{r Full Productivity Model, message = FALSE, warning = FALSE, cache = TRUE,  results = "hide"} 
...
```{r Table Pro Full Model, warning = FALSE, message = FALSE}
...
```{r Productivity Inference, message = FALSE, warning = FALSE}
